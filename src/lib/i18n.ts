...
export const publicCopy = {
  fa: {
    ...
    hero: {
      eyebrow: "کافه رستوران لوکس در قلب پونک",
      title: "روپیا؛ جایی برای طعم‌های ماندگار، قرارهای مهم و شب‌های مجلل",
      subtitle:
        "ترکیبی از فضای گرم و مجلل، قهوه‌های حرفه‌ای، صبحانه‌های ویژه و غذاهای دقیقاً طراحی‌شده برای مهمانانی که کیفیت را انتخاب می‌کنند.",
      ctaMenu: "مشاهده منو",
    ...
    atmosphere: {
      title: "فضای روپیا",
      subtitle: "نور گرم، چوب طبیعی، جزئیات سبز پسته‌ای و حس آرام یک کافه لوکس.",
      captions: [
    ...
    highlights: {
      title: "چرا روپیا؟",
      items: [
        "فضای لوکس و آرام برای قرارهای کاری و دوستانه",
